...
// Note: Nothing in this file is public — `pub` just means `pub(crate)`
...
macro_rules! gen_lab_tables {
    ($(#[$m1:meta])* $name1:ident, $(#[$m2:meta])* $name2:ident, $size:expr, [$(
        ...
        $(#[$m1])*
        pub(crate) static $name1: [OkLab; $size] = [$(
            OkLab { l: $l0, a: $a0, b: $b0 },
            OkLab { l: $l1, a: $a1, b: $b1 },
            OkLab { l: $l2, a: $a2, b: $b2 },
            OkLab { l: $l3, a: $a3, b: $b3 },
            OkLab { l: $l4, a: $a4, b: $b4 },
            OkLab { l: $l5, a: $a5, b: $b5 },
            OkLab { l: $l6, a: $a6, b: $b6 },
            OkLab { l: $l7, a: $a7, b: $b7 },
        )+];
...
gen_lab_tables! {
    ...
    // [
    //     (0.0, 0.0, 0.0), // 16
    //     (0.21945143, -0.01575777, -0.15124606), // 17
    //     (0.28178954, -0.020233974, -0.19420952), // 18
    //     (0.34082618, -0.0244731, -0.23489758), // 19
    //     (0.3973963, -0.028535247, -0.27388582), // 20
    //     (0.4520137, -0.032456964, -0.31152815), // 21
    //     (0.42065406, -0.11355172, 0.087146014), // 22
    //     (0.4395688, -0.07255453, -0.019127697), // 23
    //     (0.45908442, -0.05526048, -0.08179703), // 24
    //     (0.4849069, -0.04412508, -0.14114544), // 25
    //     (0.5158243, -0.038223833, -0.19581121), // 26
    //     (0.5505866, -0.036017746, -0.24609107), // 27
    //     (0.54014647, -0.14580768, 0.111901045), // 28
    //     (0.55183345, -0.11317666, 0.03273973), // 29
    //     (0.5644343, -0.09316474, -0.024561167), // 30
    //     (0.58191586, -0.07614604, -0.08368099), // 31
    //     (0.6039327, -0.06338224, -0.14104792), // 32
    //     (0.6299223, -0.05471745, -0.19538587), // 33
    //     (0.6533105, -0.17635529, 0.13534495), // 34
    //     (0.6613503, -0.15079442, 0.075170875), // 35
    //     (0.67017204, -0.1316404, 0.025488436), // 36
    //     (0.68268675, -0.112683296, -0.029706955), // 37
    //     (0.69887954, -0.09604159, -0.08616805), // 38
    //     (0.7185603, -0.082555294, -0.14163136), // 39
    //     (0.7617466, -0.20562664, 0.1578094), // 40
    //     (0.76767623, -0.18535519, 0.11082989), // 41
    //     (0.77423394, -0.16822815, 0.06857169), // 42
    //     (0.78364223, -0.14951977, 0.018766224), // 43
    //     (0.7959987, -0.13138655, -0.03463763), // 44
    //     (0.8112802, -0.11511931, -0.08900452), // 45
    //     (0.8664396, -0.2338874, 0.1794985), // 46
    //     (0.8710288, -0.21750051, 0.14186257), // 47
    //     (0.876124, -0.20255691, 0.10602385), // 48
    //     (0.88347876, -0.1850791, 0.06181562), // 49
    //     (0.8932213, -0.16691509, 0.012483656), // 50
    //     (0.90539926, -0.1494439, -0.039398134), // 51
    //     (0.3048706, 0.1091704, 0.061098024), // 52
    //     (0.34066075, 0.13330114, -0.08212477), // 53
    //     (0.3728961, 0.12249705, -0.14249241), // 54
    //     (0.4112718, 0.104753375, -0.19547123), // 55
    //     (0.45331943, 0.0853031, -0.24302787), // 56
    //     (0.49744356, 0.066738576, -0.2867549), // 57
    //     (0.46995294, -0.03464946, 0.09640509), // 58
    //     (0.48549724, 1.4901161e-8, 2.9802322e-8), // 59
    //     (0.50186557, 0.015191138, -0.06144744), // 60
    //     (0.5239784, 0.024147123, -0.12134954), // 61
    //     (0.55102885, 0.027281225, -0.17743394), // 62
    //     (0.5820608, 0.026062697, -0.2294375), // 63
    //     (0.5720238, -0.090493426, 0.11784816), // 64
    //     (0.58255553, -0.061045274, 0.04348156), // 65
    //     (0.5939752, -0.042566955, -0.012224644), // 66
    //     (0.60992646, -0.026922941, -0.070721805), // 67
    //     (0.63017714, -0.015574932, -0.12817168), // 68
    //     (0.6542841, -0.008513957, -0.1830216), // 69
    //     (0.6757256, -0.1359734, 0.13951313), // 70
    //     (0.683283, -0.11204216, 0.081787765), // 71
    //     (0.6915908, -0.09388909, 0.033340693), // 72
    //     (0.7034066, -0.075856745, -0.02105254), // 73
    //     (0.7187448, -0.060090452, -0.077144146), // 74
    //     (0.7374562, -0.047498286, -0.13257247), // 75
    //     (0.77847356, -0.17489696, 0.16091442), // 76
    //     (0.78417027, -0.15551075, 0.11526781), // 77
    //     (0.79047513, -0.13902286, 0.07386321), // 78
    //     (0.79953027, -0.12094766, 0.024752855), // 79
    //     (0.81143993, -0.103411436, -0.028189123), // 80
    //     (0.8261948, -0.08772239, -0.08231586), // 81
    //     (0.87947434, -0.20967159, 0.1819157), // 82
    //     (0.88393855, -0.19379553, 0.14505136), // 83
    //     (0.8888966, -0.17926407, 0.109787226), // 84
    //     (0.8960568, -0.16222385, 0.06611782), // 85
    //     (0.90554816, -0.1444853, 0.017212093), // 86
    //     (0.9174228, -0.12742159, -0.034377933), // 87
    //     (0.39147317, 0.14018172, 0.078453705), // 88
    //     (0.4145116, 0.1703483, -0.042265296), // 89
    //     (0.43742996, 0.17116722, -0.10545346), // 90
    //     (0.46677762, 0.16226044, -0.16319314), // 91
    //     (0.5008869, 0.1473515, -0.21550325), // 92
    //     (0.53832316, 0.12967274, -0.26336262), // 93
    //     (0.51425487, 0.018674493, 0.104892075), // 94
    //     (0.5274639, 0.0496756, 0.01707694), // 95
    //     (0.5415629, 0.06461343, -0.042637587), // 96
    //     (0.5608929, 0.07386151, -0.102464914), // 97
    //     (0.5849188, 0.0771327, -0.159426), // 98
    //     (0.61291206, 0.0755021, -0.21275038), // 99
    //     (0.6034494, -0.04449226, 0.123790234), // 100
    //     (0.6130028, -0.017503172, 0.053987086), // 101
    //     (0.6234093, 0.0, 5.9604645e-8), // 102
    //     (0.63802856, 0.015011221, -0.057689905), // 103
    //     (0.6567161, 0.025852472, -0.11504513), // 104
    //     (0.67912704, 0.03232506, -0.17026287), // 105
    //     (0.6988905, -0.09849526, 0.14385992), // 106
    //     (0.70599484, -0.07601568, 0.08859268), // 107
    //     (0.71381783, -0.058706045, 0.041449428), // 108
    //     (0.72497016, -0.041380167, -0.012053847), // 109
    //     (0.7394914, -0.026206434, -0.067693174), // 110
    //     (0.75726813, -0.014172643, -0.12302011), // 111
    //     (0.79621685, -0.14456567, 0.16422883), // 112
    //     (0.80168194, -0.1260303, 0.11996448), // 113
    //     (0.80773467, -0.11014545, 0.07946664), // 114
    //     (0.81643677, -0.09264472, 0.0311113), // 115
    //     (0.8278983, -0.07562235, -0.021313608), // 116
    //     (0.8421229, -0.06040263, -0.075155795), // 117
    //     (0.8935169, -0.18487233, 0.18453145), // 118
    //     (0.8978524, -0.16951057, 0.14848405), // 119
    //     (0.9026691, -0.15539065, 0.11383593), // 120
    //     (0.9096284, -0.13877949, 0.07075125), // 121
    //     (0.91886026, -0.121448606, 0.022314906), // 122
    //     (0.93042046, -0.10476264, -0.028947413), // 123
    //     (0.47348917, 0.16955064, 0.09489027), // 124
    //     (0.48961607, 0.19914411, -0.0056277215), // 125
    //     (0.50647354, 0.20740664, -0.06772506), // 126
    //     (0.5290742, 0.20702776, -0.12754661), // 127
    //     (0.5565127, 0.19929409, -0.18318456), // 128
    //     (0.5877834, 0.18646017, -0.23460689), // 129
    //     (0.5673052, 0.06971961, 0.115181595), // 130
    //     (0.5783239, 0.097317025, 0.036917865), // 131
    //     (0.59022695, 0.112386584, -0.020126611), // 132
    //     (0.6067754, 0.12283531, -0.07919431), // 133
    //     (0.6276702, 0.1276092, -0.136657), // 134
    //     (0.6524067, 0.12718725, -0.19118196), // 135
    //     (0.64375144, 0.005603671, 0.13149554), // 136
    //     (0.6522333, 0.030020624, 0.06721881), // 137
    //     (0.6615167, 0.04664123, 0.015582085), // 138
    //     (0.6746394, 0.061347187, -0.040827215), // 139
    //     (0.6915419, 0.072224855, -0.09781283), // 140
    //     (0.71198195, 0.07878995, -0.15329331), // 141
    //     (0.72987574, -0.053813457, 0.14972496), // 142
    //     (0.7364349, -0.033008248, 0.09760895), // 143
    //     (0.74367183, -0.016630739, 0.052231967), // 144
    //     (0.7540173, 2.9802322e-8, 0.0), // 145
    //     (0.76753694, 0.014700472, -0.054931283), // 146
    //     (0.78415823, 0.026378334, -0.110021114), // 147
    //     (0.8205774, -0.10619977, 0.16880968), // 148
    //     (0.8257473, -0.08871445, 0.12638414), // 149
    //     (0.8314778, -0.07356107, 0.08712673), // 150
    //     (0.8397276, -0.05673024, 0.039831817), // 151
    //     (0.85061294, -0.040264457, -0.01184243), // 152
    //     (0.8641523, -0.025509328, -0.065247), // 153
    //     (0.9131206, -0.15226507, 0.18820173), // 154
    //     (0.91728586, -0.13756642, 0.15326786), // 155
    //     (0.9219153, -0.12397346, 0.119472444), // 156
    //     (0.9286084, -0.10790333, 0.077209115), // 157
    //     (0.93749535, -0.09106943, 0.029443502), // 158
    //     (0.94863683, -0.07482481, -0.021340072), // 159
    //     (0.5520787, 0.19769253, 0.11064014), // 160
    //     (0.5640697, 0.22454189, 0.026858658), // 161
    //     (0.57693666, 0.23668095, -0.0318335), // 162
    //     (0.5946834, 0.24246907, -0.09144947), // 163
    //     (0.6168897, 0.24139005, -0.14871669), // 164
    //     (0.64294016, 0.2344524, -0.20262581), // 165
    //     (0.62572527, 0.11587854, 0.12661523), // 166
    //     (0.6348868, 0.14033566, 0.057751626), // 167
    //     (0.64487666, 0.15544844, 0.0041345954), // 168
    //     (0.65892786, 0.1672869, -0.053379238), // 169
    //     (0.6769157, 0.1741836, -0.110718966), // 170
    //     (0.69852346, 0.17599791, -0.16603184), // 171
    //     (0.6907873, 0.05503121, 0.14057681), // 172
    //     (0.6982251, 0.07696596, 0.08222404), // 173
    //     (0.7064011, 0.09277296, 0.03344357), // 174
    //     (0.7180268, 0.107402384, -0.021185815), // 175
    //     (0.7331131, 0.11875799, -0.07741475), // 176
    //     (0.75151044, 0.12605298, -0.13290465), // 177
    //     (0.7675407, -0.006118208, 0.15691769), // 178
    //     (0.7735164, 0.012948602, 0.10840064), // 179
    //     (0.7801225, 0.028380692, 0.06517321), // 180
    //     (0.78959334, 0.044388056, 0.014583707), // 181
    //     (0.80201817, 0.05880031, -0.039344966), // 182
    //     (0.8173637, 0.07041523, -0.09399748), // 183
    //     (0.8510201, -0.06274539, 0.17457628), // 184
    //     (0.85585356, -0.046420276, 0.13434619), // 185
    //     (0.86121625, -0.0320659, 0.09662074), // 186
    //     (0.86894715, -0.015935779, 0.050677836), // 187
    //     (0.8791687, -8.940697e-8, 5.9604645e-8), // 188
    //     (0.8919143, 0.014378905, -0.05278641), // 189
    //     (0.9380859, -0.113731384, 0.19290358), // 190
    //     (0.9420487, -0.09980038, 0.15934044), // 191
    //     (0.94645524, -0.08681399, 0.12661463), // 192
    //     (0.95283073, -0.0713543, 0.08540124), // 193
    //     (0.961305, -0.055061042, 0.038511813), // 194
    //     (0.9719444, -0.039266914, -0.011629283), // 195
    //     (0.6279554, 0.22486295, 0.1258463), // 196
    //     (0.637274, 0.2485399, 0.05552101), // 197
    //     (0.6474213, 0.2622939, 0.0013148785), // 198
    //     (0.6616679, 0.27199948, -0.05650395), // 199
    //     (0.67986554, 0.27608934, -0.11391926), // 200
    //     (0.7016738, 0.27456632, -0.16915613), // 201
    //     (0.68721557, 0.15724804, 0.1387254), // 202
    //     (0.6948738, 0.17885262, 0.078464955), // 203
    //     (0.7032815, 0.19371217, 0.028722703), // 204
    //     (0.71521485, 0.20665306, -0.02653575), // 205
    //     (0.730664, 0.21563458, -0.08306438), // 206
    //     (0.74945384, 0.21999735, -0.13860208), // 207
    //     (0.74263614, 0.10158342, 0.15066692), // 208
    //     (0.74912506, 0.1212146, 0.09817162), // 209
    //     (0.75628394, 0.13620797, 0.052571774), // 210
    //     (0.76651573, 0.15080526, 0.00016850233), // 211
    //     (0.77988285, 0.16282451, -0.05487287), // 212
    //     (0.7963107, 0.17121884, -0.11002153), // 213
    //     (0.81059945, 0.041587323, 0.16520673), // 214
    //     (0.81599617, 0.058954954, 0.12048274), // 215
    //     (0.82197315, 0.07345533, 0.07967597), // 216
    //     (0.8305656, 0.08889663, 0.03105414), // 217
    //     (0.8418806, 0.10316551, -0.02156651), // 218
    //     (0.8559195, 0.11496708, -0.07553446), // 219
    //     (0.886771, -0.016925097, 0.18139815), // 220
    //     (0.8912491, -0.001794666, 0.14359498), // 221
    //     (0.8962219, 0.011737704, 0.107628465), // 222
    //     (0.9034013, 0.027169466, 0.06329459), // 223
    //     (0.9129136, 0.042629868, 0.013854206), // 224
    //     (0.92480606, 0.056749493, -0.038115144), // 225
    //     (0.9679827, -0.07136908, 0.19856972), // 226
    //     (0.97172195, -0.058264583, 0.16657531), // 227
    //     (0.9758818, -0.04592961, 0.13510126), // 228
    //     (0.98190516, -0.03111574, 0.095143616), // 229
    //     (0.98992103, -0.015371114, 0.049328506), // 230
    //     (1.0, 0.0, 5.9604645e-8), // 231
    //     (0.13440923, 3.7252903e-9, 7.450581e-9), // 232
    //     (0.18220371, -7.450581e-9, 0.0), // 233
    //     (0.22644986, 2.2351742e-8, 0.0), // 234
    //     (0.26861826, 4.4703484e-8, 0.0), // 235
    //     (0.30918562, 0.0, 0.0), // 236
    //     (0.34845966, 1.4901161e-8, 0.0), // 237
    //     (0.38665435, 0.0, 0.0), // 238
    //     (0.4239265, -2.9802322e-8, 0.0), // 239
    //     (0.46039563, -8.940697e-8, 2.9802322e-8), // 240
    //     (0.49615562, -2.9802322e-8, 2.9802322e-8), // 241
    //     (0.5312818, 8.940697e-8, 2.9802322e-8), // 242
    //     (0.56583625, -2.9802322e-8, 0.0), // 243
    //     (0.5998708, 2.9802322e-8, 2.9802322e-8), // 244
    //     (0.633429, 0.0, 0.0), // 245
    //     (0.6665481, 8.940697e-8, -5.9604645e-8), // 246
    //     (0.6992607, -5.9604645e-8, 5.9604645e-8), // 247
    //     (0.731595, -5.9604645e-8, 0.0), // 248
    //     (0.76357573, -2.9802322e-8, 5.9604645e-8), // 249
    //     (0.7952249, 2.9802322e-8, 5.9604645e-8), // 250
    //     (0.8265622, 8.940697e-8, 0.0), // 251
    //     (0.8576052, -5.9604645e-8, 5.9604645e-8), // 252
    //     (0.8883697, 8.940697e-8, 0.0), // 253
    //     (0.9188701, -2.9802322e-8, 5.9604645e-8), // 254
    //     (0.9491192, 1.7881393e-7, 0.0), // 255
    // ]
    [
        (0.0, 0.0, 0.0),
...
mod test {
    ...
    fn test_ansi_tables() {
        ...
        for (i, &c) in ANSI256_RGB.iter().enumerate() {
            let lab = OkLab::from_srgb8(c.0, c.1, c.2);
        ...
        #[cfg(feature = "88color")]
        {
            let it = ANSI88_RGB
                .iter()
                .map(|&(r, g, b)| OkLab::from_srgb8(r, g, b)); //.collect::<Vec<_>>();
            for (l, a, b) in it.map(|c| (c.l, c.a, c.b)) {
                std::println!("({}, {}, {}),", l, a, b);
            }
    ...
    fn test_idx2named() {
        ...
        use crate::imp::oklab::OkLab;
        let lab16 = ANSI16_TO_RGB
            .iter()
            .map(|&(r, g, b)| OkLab::from_srgb8(r, g, b))
            .collect::<Vec<_>>();
